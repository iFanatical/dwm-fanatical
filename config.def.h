...
static const char *fonts[]          	= { "JetBrainsMonoNL Nerd Font Propo:bold:pixelsize=14:antialias=true:autohint=true" };
...
static const float mfacts[]	= { 0.50, 0.50, 0.80, 0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.50, 0.25, 0.50 };
